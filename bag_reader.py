...
def validate_args(cmd_args):
    ...
    if valid:
        """ 1. If info is requested, that is the only argument allowed.
            2. A topic and output file may be specified.
            3. A topic may be specified. Output file name will be autogenerated.
...
if __name__ == "__main__":
    ...
    if args.info:
        ...
        if args.out_file is None:
            out_file = os.path.splitext(args.bag)[0] + args.topic.replace('/', '_') + '.csv'
        else:
            out_file = args.out_file
        write_to_csv(args.bag, out_file, args.topic)
